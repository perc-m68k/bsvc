...
#ifndef M68K_DEVICES_M68681_TCP_HPP_
#define M68K_DEVICES_M68681_TCP_HPP_
...
class M68681_tcp : public BasicDevice {
public:
  M68681_tcp(const std::string &args, BasicCPU &cpu);
  ~M68681_tcp();
...
#endif  // M68K_DEVICES_M68681_TCP_HPP_
